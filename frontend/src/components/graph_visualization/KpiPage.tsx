...
const AnalyticsDashboard: React.FC<Props> = ({ fileId }) => {
    ...
    const runActivityTimeKpi = async () => {
        ...
        try {
            ...
            const res = await axios.get(`http://localhost:3000/v1/kpi/case_time_stats/${currentCnFileId}`, {
                params: {
                    object_type: selectedLeftObjectType,
                    from_activity: fromActivity,
                    to_activity: toActivity,
                },
            });
...
console.log(data);
    ...
    }, [selectedLeftAttribute, selectedRightAttribute, selectedLeftObjectType, selectedRightObjectType, selectedLeftEventType, selectedRightEventType, leftIntraCaseAgg, rightIntraCaseAgg, selectedOperation]);
    console.log(params);
    console.log('params');
    const {
        data: attributeStatsData,
    ...
    return (
        <div className="w-full h-full overflow-y-auto bg-slate-100 p-6">
            ...
            "
                        ...
                        <div>
                            <label className="block text-sm font-medium text-slate-700 mb-2">Object Type(Case Notion)</label>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) => {
                                    ...
                                    const leftObjectType = metadata?.object_types.find((item: any) => item.name === value1);
 ...
 <div>
                            ...
                            <select
                                ...
                                onChange={(e) => {
                                    ...
                                    const rightObjectType = metadata?.object_types.find((item: any) => item.name === value2);

                                    const firstAttribute = rightObjectType?.attributes.find((attr: any) => attr.numeric);
