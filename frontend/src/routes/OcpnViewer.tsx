                                    ...
                                    <div className="overflow-hidden pl-4 pr-2 py-3 space-y-5">
                                        <div className="space-y-2">
                                            <div className="flex justify-between text-[10px] font-bold text-slate-400 uppercase">
                                                ...
                                                <span>{vizParams.hSpacing}px</span>
                                            </div>
                                            <Slider
                                                value={[vizParams.hSpacing]}
                                                min={80}
                                                max={400}
                                                step={10}
                                                onValueChange={(v) => setVizParams((p) => ({ ...p, hSpacing: v[0] }))}
                                            />
                                        </div>
                                        <div className="space-y-2">
                                            <div className="flex justify-between text-[10px] font-bold text-slate-400 uppercase">
                                                <Label>Vertical Gap</Label>
                                                <span>{vizParams.vSpacing}px</span>
                                            </div>
                                            <Slider
                                                value={[vizParams.vSpacing]}
                                                min={60}
                                                max={300}
                                                step={10}
                                                onValueChange={(v) => setVizParams((p) => ({ ...p, vSpacing: v[0] }))}
                                            />
                                        </div>
                                        <div className="space-y-2">
                                            <div className="flex justify-between text-[10px] font-bold text-slate-400 uppercase">
                                                <Label>Node Size</Label>
                                                <span>{vizParams.nodeSize}px</span>
                                            </div>
                                            <Slider
